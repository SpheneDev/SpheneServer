...
public sealed class SpheneConfigurationServiceServer<T> : IDisposable, IConfigurationService<T> where T : class, ISpheneConfiguration
{
    ...
    public SpheneConfigurationServiceServer(IOptionsMonitor<T> config)
    {
        _config = config;
