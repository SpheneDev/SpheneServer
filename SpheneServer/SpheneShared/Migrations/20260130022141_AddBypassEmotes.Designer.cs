...
namespace SpheneServer.Migrations
{
    ...
    [Migration("20260130022141_AddBypassEmotes")]
    partial class AddBypassEmotes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpheneShared.Models.CharaData", b =>
                {
                    ...
                    b.Property<string>("BypassEmoteData")
                        .HasColumnType("text")
                        .HasColumnName("bypass_emote_data");
            ...
            modelBuilder.Entity("SpheneShared.Models.ModShareHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_mod_share_history");

                    b.HasIndex("Hash")
                        .HasDatabaseName("ix_mod_share_history_hash");

                    b.HasIndex("RecipientUID")
                        .HasDatabaseName("ix_mod_share_history_recipient_uid");

                    b.HasIndex("SenderUID")
                        .HasDatabaseName("ix_mod_share_history_sender_uid");

                    b.HasIndex("SharedAt")
                        .HasDatabaseName("ix_mod_share_history_shared_at");

                    b.ToTable("mod_share_history", (string)null);
                });
            ...
            modelBuilder.Entity("SpheneShared.Models.UserPermissionSet", b =>
                {
                    ...
                    b.Property<bool>("DisableVFXInDuty")
                        .HasColumnType("boolean")
                        .HasColumnName("disable_vfx_in_duty");
