...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpheneServer.Models.Auth", b =>
                {
            ...
            modelBuilder.Entity("SpheneServer.Models.Banned", b =>
                {
            ...
            modelBuilder.Entity("SpheneServer.Models.BannedRegistrations", b =>
                {
            ...
            modelBuilder.Entity("SpheneServer.Models.ClientPair", b =>
                {
                    b.Property<string>("UserUID")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
            ...
            modelBuilder.Entity("SpheneServer.Models.FileCache", b =>
                {
            ...
            modelBuilder.Entity("SpheneServer.Models.ForbiddenUploadEntry", b =>
                {
                    b.Property<string>("Hash")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
            ...
            modelBuilder.Entity("SpheneServer.Models.LodeStoneAuth", b =>
                {
            ...
            modelBuilder.Entity("SpheneServer.Models.User", b =>
                {
            ...
            modelBuilder.Entity("SpheneServer.Models.Auth", b =>
                {
                    b.HasOne("SpheneServer.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("SpheneServer.Models.ClientPair", b =>
                {
                    b.HasOne("SpheneServer.Models.User", "OtherUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SpheneServer.Models.FileCache", b =>
                {
                    b.HasOne("SpheneServer.Models.User", "Uploader")
                        .WithMany()
