...
public class SpheneMetrics
{
    public SpheneMetrics(ILogger<SpheneMetrics> logger, List<string> countersToServe, List<string> gaugesToServe)
    {
        logger.LogInformation("Initializing SpheneMetrics");
