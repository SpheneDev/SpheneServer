...
public class RedisDbUserRequirementHandler : AuthorizationHandler<UserRequirement, HubInvocationContext>
{
    ...
    public RedisDbUserRequirementHandler(IDbContextFactory<SpheneDbContext> dbContextFactory, ILogger<RedisDbUserRequirementHandler> logger, IDatabase redisDb)
    {
