...
{
    public static async Task<(bool, string)> MigrateOrDeleteGroup(SpheneDbContext context, Group group, List<GroupPair> groupPairs, int maxGroupsByUser)
    {
    ...
    public static async Task PurgeUser(ILogger _logger, User user, SpheneDbContext dbContext, int maxGroupsByUser)
    {
