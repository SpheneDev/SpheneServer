...
{
    private readonly IOptionsMonitor<SpheneConfigurationBase> _configuration;
    ...
    public ServerTokenGenerator(IOptionsMonitor<SpheneConfigurationBase> configuration, ILogger<ServerTokenGenerator> logger)
    {
    ...
    private string GenerateToken()
    {
        ...
        var token = new SecurityTokenDescriptor()
        {
            ...
            {
                new Claim(SpheneClaimTypes.Uid, _configuration.CurrentValue.ShardName),
            new Claim(SpheneClaimTypes.Internal, "true"),
            new Claim(SpheneClaimTypes.Expires, DateTime.Now.AddYears(1).Ticks.ToString(CultureInfo.InvariantCulture))
            }),
