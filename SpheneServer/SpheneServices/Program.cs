...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        using (var scope = host.Services.CreateScope())
        {
            ...
            logger.LogInformation("Loaded Sphene Services Configuration (IsMain: {isMain})", options.IsMain);
            logger.LogInformation(options.ToString());
            logger.LogInformation("Loaded Sphene Server Configuration (IsMain: {isMain})", optionsServer.IsMain);
