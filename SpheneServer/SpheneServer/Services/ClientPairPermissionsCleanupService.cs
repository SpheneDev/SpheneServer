...
public class ClientPairPermissionsCleanupService(ILogger<ClientPairPermissionsCleanupService> _logger, IDbContextFactory<SpheneDbContext> _dbContextFactory,
    ...
    : BackgroundService
{
    ...
    private async Task<List<UserPermissionSet>> UserPermissionCleanup(int userNr, int totalUsers, string uid, SpheneDbContext dbContext, List<string> pairs)
    {
    ...
    private async Task<List<string>> GetAllPairsForUser(string uid, SpheneDbContext dbContext, CancellationToken ct)
    {
