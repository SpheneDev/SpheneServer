...
namespace SpheneServer.Hubs
{
    public partial class SpheneHub
    {
        ...
        public Task Client_UserReceiveUploadStatus(UserUploadStatusDto dto) => throw new PlatformNotSupportedException("Calling clientside method on server not supported");
        ...
        public Task Client_UserReceiveCharacterDataAcknowledgmentV2(CharacterDataAcknowledgmentEventDto acknowledgmentEventDto) => throw new PlatformNotSupportedException("Calling clientside method on server not supported");
