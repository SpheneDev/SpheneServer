...
public partial class SpheneHub
{
    ...
    public async Task<CharaDataFullDto?> CharaDataCreate()
    {
        ...
        _logger.LogCallInfo(SpheneHubLogger.Args("SUCCESS", charaDataId));
    ...
    public async Task<bool> CharaDataDelete(string id)
    {
        ...
        {
            _logger.LogCallWarning(SpheneHubLogger.Args("FAILURE", id, ex.Message));
            return false;
        }
    }
    ...
    {
        _logger.LogCallInfo(SpheneHubLogger.Args(id));
    ...
    public async Task<List<CharaDataMetaInfoDto>> CharaDataGetShared()
    {
        ...
        _logger.LogCallInfo(SpheneHubLogger.Args("SUCCESS", sharedCharaData.Count));
    ...
    public async Task<CharaDataFullDto?> CharaDataUpdate(CharaDataUpdateDto updateDto)
    {
        ...
        if (anyChanges)
        {
            charaData.UpdatedDate = DateTime.UtcNow;
            await DbContext.SaveChangesAsync().ConfigureAwait(false);
            _logger.LogCallInfo(SpheneHubLogger.Args("SUCCESS", anyChanges));
        }
    ...
    private async Task<CharaData> GetCharaDataById(string id, string methodName)
    {
        ...
        if (splitid.Length != 2)
        {
            _logger.LogCallWarning(SpheneHubLogger.Args("INVALID", id));
        ...
        if (charaData == null)
        {
            _logger.LogCallWarning(SpheneHubLogger.Args("NOT FOUND", id));
        ...
        {
            _logger.LogCallWarning(SpheneHubLogger.Args("UNAUTHORIZED", id));
