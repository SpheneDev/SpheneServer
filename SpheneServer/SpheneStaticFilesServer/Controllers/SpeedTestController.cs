...
public class SpeedTestController : ControllerBase
{
    ...
    [HttpGet(SpheneFiles.Speedtest_Run)]
    public async Task<IActionResult> DownloadTest(CancellationToken cancellationToken)
    {
        var user = HttpContext.User.Claims.First(f => string.Equals(f.Type, SpheneClaimTypes.Uid, StringComparison.Ordinal)).Value;
