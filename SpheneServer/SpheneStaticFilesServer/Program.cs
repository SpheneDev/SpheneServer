...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        using (var scope = host.Services.CreateScope())
        {
            ...
            var optionsServer = host.Services.GetService<IConfigurationService<SpheneConfigurationBase>>();
            var logger = host.Services.GetService<ILogger<Program>>();
            logger.LogInformation("Loaded Sphene Static Files Server Configuration (IsMain: {isMain})", options.IsMain);
            logger.LogInformation(options.ToString());
            logger.LogInformation("Loaded Sphene Server Auth Configuration (IsMain: {isMain})", optionsServer.IsMain);
