...
public class ShardFileCleanupService : IHostedService
{
    ...
    public ShardFileCleanupService(SpheneMetrics metrics, ILogger<MainFileCleanupService> logger, IConfigurationService<StaticFilesServerConfiguration> configuration)
    {
        _metrics = metrics;
        _logger = logger;
